...
export default class DatabaseUtils {
  ...
  public static pushWalletLookupInAggregation(lookupParams: DbLookup, additionalPipeline: Record<string, any>[] = []): void {
    DatabaseUtils.pushCollectionLookupInAggregation('wallets', {
      ...lookupParams
    }, additionalPipeline);
  }
